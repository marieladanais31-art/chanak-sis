  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center border-b pb-2">
        <h3 className="text-lg font-bold text-slate-800">Seleccionar Rol Independiente</h3>
        {selectedRoleName && (
          <span className="text-sm px-3 py-1 bg-slate-100 text-slate-700 rounded-full font-bold border border-slate-200 shadow-sm">
